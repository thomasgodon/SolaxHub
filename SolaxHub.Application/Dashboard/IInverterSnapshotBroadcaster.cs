...
/// <summary>
/// In-memory pub/sub for the latest dashboard snapshot (serialized JSON). The dashboard
/// notification handler publishes on every refresh; SSE connections subscribe to receive pushes.
/// </summary>
public interface IInverterSnapshotBroadcaster
{
