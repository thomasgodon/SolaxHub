...
internal sealed class InverterSnapshotBroadcaster : IInverterSnapshotBroadcaster
{
    ...
    private sealed class Subscription(InverterSnapshotBroadcaster broadcaster, Guid id) : IDisposable
    {
